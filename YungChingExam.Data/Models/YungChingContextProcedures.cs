...
{
    public partial class YungChingContext
    {
        private IYungChingContextProcedures _procedures;

        public virtual IYungChingContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new YungChingContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IYungChingContextProcedures GetProcedures()
        {
            return Procedures;
        }
    ...
    public partial class YungChingContextProcedures : IYungChingContextProcedures
    {
        private readonly YungChingContext _context;

        public YungChingContextProcedures(YungChingContext context)
        {
            _context = context;
        }
